...
import { ADMIN_ADDRESS, GLOBAL_AUTHORITY_SEED, REWARD_TOKEN_MINT, USER_POOL_SEED, USER_POOL_SIZE } from './constant';
...
export const createLockPnftTx = async (
    ...
    if (poolAccount === null || poolAccount.data === null) {
        ...
        const tx_initUserPool = await createInitUserTx(userAddress, connection, program);
